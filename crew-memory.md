...
## Dispatcher Rules
- Mini PC tasks fall back to Desktop PC when Mini PC is offline
- All agents ACK within 30 seconds


﻿---
## UPDATE: Test Memory Write
**Agent:** Kimi Claw Desktop
**Date:** 2026-07-27

This is a test update to verify the memory sharing pipeline works.
---
